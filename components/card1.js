export default function Card1({ image, title, description, buttonText, buttonLink }) {
  return (
    ...
    <div className="bg-white rounded-lg shadow-md group-hover:shadow-xl p-4">
      ...
      {title && <h3 className="text-xl font-bold mb-2 text-[palevioletred] group-hover:text-pink-600">{title}</h3>}
